...
This is simple [Ontario tax calculator](http://incometax.calculatorscanada.ca/ontario) calculates income taxes for residents of Ontario province in Canada for 2015 fiscal year. 
Install ealier version ([v2014.2](https://wordpress.org/plugins/cc-ontario-tax-calculator/developers/)) if you need tax calculator for 2014 or ([v2013.2](https://wordpress.org/plugins/cc-ontario-tax-calculator/developers/)) if you need tax calculator for 2013
...
Please visit [plugin home page](http://incometax.calculatorscanada.ca/income-tax-widgets) for more detailed installation and setup instructions
